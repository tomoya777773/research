...
if __name__=="__main__":
    ...
    while True:
        ...
        if plot:
            ...
            set_plt()
            if save_movie:
                plt.savefig('../data/low_high/gpis/movie/step{}.png'.format(movie_num))
                movie_num += 1
    ...
    X2 = np.append(X2, [np.array([0.5, 1])], axis=0)
    Y2 = np.append(Y2, [1])[:,None]
    ...
    for i in range(80):
        ...
        if save_data:
            ...
            plt.savefig('../data/low_high/gpis/estimate_surface/step{}.png'.format(i+1))
            plt.clf()

            # set_plt()
            # plt.plot(x2_0, y2_0, linewidth=3, color=(1.0, 0.0, 0.0))
            # plt.savefig('../data/low_high/gpis/true_surface/step{}.png'.format(i+1))
            # plt.clf()
    ...
    if save_data:
        np.save('../data/low_high/gpis/value/var', var_list)
