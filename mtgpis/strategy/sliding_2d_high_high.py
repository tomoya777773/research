...
if __name__=="__main__":
    ...
    while True:
        ...
        if plot:
            ...
            set_plt()
            if save_movie:
                plt.savefig('../data/high_high/mtgpis/movie/step{}.png'.format(movie_num))
                movie_num += 1
    ...
    for i in range(140):
        ...
        if save_data:
            ...
            plt.savefig('../data/high_high/mtgpis/estimate_surface/step{}.png'.format(i+1))
            plt.clf()

            # set_plt()
            # plt.plot(x2_0, y2_0, linewidth=3, color=(1.0, 0.0, 0.0))
            # plt.savefig('../data/high_high/mtgpis/true_surface/step{}.png'.format(i+1))
            # plt.clf()
    ...
    if save_data:
        np.save('../data/high_high/mtgpis/value/var', var_list)
        np.save('../data/high_high/mtgpis/value/simirality', simirality_list)
