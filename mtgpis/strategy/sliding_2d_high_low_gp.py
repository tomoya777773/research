...
if __name__=="__main__":
    ...
    while True:
        ...
        if plot:
            ...
            set_plt()
            if save_movie:
                plt.savefig('../data/high_low/gpis/movie/step{}.png'.format(movie_num))
                movie_num += 1
    ...
    for i in range(65):
        ...
        if save_data:
            ...
            plt.savefig('../data/high_low/gpis/estimate_surface/step{}.png'.format(i+1))
            plt.clf()

            # set_plt()
            # plt.plot(x2_0, y2_0, linewidth=3, color=(1.0, 0.0, 0.0))
            # plt.savefig('../data/high_low/gpis/true_surface/step{}.png'.format(i+1))
            # plt.clf()
    ...
    if save_data:
        np.save('../data/high_low/gpis/value/var', var_list)
