...
print(w1)
print(h1)
_, img1, _, _ = cv2.floodFill(img1, mask1, seedPoint=(int(30), int(300)), newVal=(0, 0, 255))
...
for i in range(len(picList)):
    ...
    # _, img2, _, _ = cv2.floodFill(img2, mask2, seedPoint=(int(350), int(350)), newVal=(0, 0, 255))
    # _, img2, _, _ = cv2.floodFill(img2, mask2, seedPoint=(int(350), int(350)), newVal=(0, 0, 255)) # low_high
    _, img2, _, _ = cv2.floodFill(img2, mask2, seedPoint=(int(360), int(270)), newVal=(0, 0, 255)) # deco
