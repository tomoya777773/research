...
def mtgpis_plot_3d(mm0_po, ss):
    ...
    N = ss
    ax.plot_surface(mm0_po[0], mm0_po[1], mm0_po[2], facecolors=cm.rainbow(N), linewidth=0, rstride=1, cstride=1, antialiased=False,vmin=N.min(), vmax=N.max())
...
if __name__=="__main__":
    ...
    # Task 2
    X2 = np.array([[0.01, 0.02, 0.6],[-0.03, -0.01, 0.6]])
    Y2 = np.array([[1], [1]])
    T2 = 1
    radius = 0.2
