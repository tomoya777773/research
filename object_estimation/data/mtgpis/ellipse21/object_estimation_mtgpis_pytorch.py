...
if __name__=="__main__":
    ...
    for i in range(200):
            ...
            np.save("../data/mtgpis/ellipse21/step_{}".format(i), [np.array(mean), np.array(var), np.array(gp_model.task_kernel)])
    ...
    np.save("../data/mtgpis/ellipse21/position", position_list)
    np.save("../data/mtgpis/ellipse21/error", error_list)
    np.save("../data/mtgpis/ellipse21/var", var_ave_list)
